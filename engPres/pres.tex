  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{tikzpicture}[yscale=0.8]
        ...
        \uncover<15-16>{\node[draw,rectangle] (a) at (-1,1) {\textcolor{red}{FORGET}};}
        \uncover<17->{\node[draw,rectangle,black!20!white] (a) at (-1,1) {\textcolor{red!30!white}{FORGET}};}
        \uncover<17-18>{\node[draw,rectangle] (a) at (-1,0.3) {\textcolor{red}{FORGET}};}
        \uncover<19->{\node[draw,rectangle,black!20!white] (a) at (-1,0.3) {\textcolor{red!30!white}{FORGET}};}
